...
exports.handler = async(event, context, callback) => {
    ...
    try {
        ...
        let info = await insertDevice(idqras_owner, idqra, token, device_type);
    ...
    function getQraInfo(qra) {
        console.log("getQraInfo");
        return new Promise(function(resolve, reject) {
            // The Promise constructor should catch any errors thrown on this tick.
            // Alternately, try/catch and reject(err) on catch.

            conn
                .query("SELECT idqras FROM qras where qra=? LIMIT 1", qra.toUpperCase(), function(err, info) {
    ...
    function insertDevice(idqra_owner, qra, token, device_type) {
        return new Promise(function(resolve, reject) {
            // The Promise constructor should catch any errors thrown on this tick.
            // Alternately, try/catch and reject(err) on catch.
