...
exports.handler = async(event, context, callback) => {
    ...
    function getQsoStakeholders(idqso) {
        return new Promise(function (resolve, reject) {
            ...
            conn
                .query("Select distinct q.idqra, r.qra from qsos_qras as q inner join qras as r on q.idq" +
    ...
    function getFollowingMe(idqra_owner) {
        return new Promise(function (resolve, reject) {
            ...
            conn
                .query("SELECT f.*, r.qra from qra_followers as f inner join qras as r on f.idqra_follow" +
