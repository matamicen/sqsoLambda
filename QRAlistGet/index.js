...
exports.handler = (event, context, callback) => {
    ...
    conn.query ( "SELECT qra, CONCAT(COALESCE(qra,''), ' ', COALESCE(firstname,''),' ', COALESCE(lastname,'')) AS name  FROM qras where qra LIKE ?", qra.toUpperCase() + '%',   function(error,info) {  // querying the database
        if (error) {
