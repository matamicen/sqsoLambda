    ...
    console.log('Received context:', JSON.stringify(context, null, 2));
            ...
            // conn.connect();
             ...
             // GET QRA ID of OWNER
                    ...
                    console.log(qso);
                    conn.query ( "SELECT qras.idcognito, qras.idqras from qras inner join qsos on qras.idqras = qsos.idqra_owner where qsos.idqsos =? and qras.idcognito=?", [qso , sub],   function(error,info) {  
                        if (error) {
                   ...
                   console.log("info=",info);
                    if (error) {
                        ...
                        conn.query('INSERT INTO qsos_qras SET ?', post, function(error, info) {
                            ...
                            if (info.insertId){
                                console.log("QSOQRA inserted", info.insertId);
                                conn.query('SELECT * FROM qra_followers where idqra=? and idqra_followed=?', [idqras_owner, idqras], function(error, info) {
                                    if (error) {
