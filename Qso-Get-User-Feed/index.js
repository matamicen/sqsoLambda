                        ...
                        function (qso, callback1) {
                            ...
                            async.series([
                                    ...
                                    function (callback2) { //GET QRAS of QSO
                                        ...
                                        conn.query("SELECT qra, profilepic FROM sqso.qras where idqras in ( SELECT idqra FROM sqso.qsos_qras where isOwner = false and idqso = ? ) ", idqsos, function (error, qras) {
                                            if (!error) {
                                                console.log(qras);
